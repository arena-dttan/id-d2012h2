...
<header>
	...
	<div class="heroe">
		...
		<h1>Welcome to Arena Multimedia</h1>

		<h2>The small team with powerful features</h2>
...
<div class="further" style="min-height:300px;">
...
<footer>
	<div class="environment">
		...
		<p>FC Thanh Tan in Arena Multimedia </p>
...
<script>
	...
	$(document).ready(function(){		
		...
		if (!VNRISIntranet ) {
			...
			if (username_gg ) {
				setCookie('VNRISIntranet', username_gg, 365 );
				var check_gg = 1;
			}
		}
